...
class ProfileDraft {
  ...
  factory ProfileDraft.fromDbRow(Map<String, dynamic> row) {
    ...
    return ProfileDraft(
      photoUrls: strList(row['photo_urls']).isNotEmpty ? strList(row['photo_urls']) : strList(row['photos']),
      ...
      interests: strList(row['interests']).isNotEmpty ? strList(row['interests']) : strList(row['hobbies']),
