    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          _T(Icons.save_alt_rounded, 'Auto-save Media', s['auto_save_media'] as bool? ?? false, (_) => n.toggleBool('auto_save_media')),
          _T(Icons.alarm_rounded, 'Call Reminders', s['call_reminders'] as bool? ?? true, (_) => n.toggleBool('call_reminders')),
          ...
          _T(Icons.person_outline, 'Bio Cleanup', n.aiVal('ai_writing_help', 'bio_cleanup'), (_) => n.toggleAi('ai_writing_help', 'bio_cleanup')),
          _T(Icons.event_note_rounded, 'Event Description Cleanup', n.aiVal('ai_writing_help', 'event_cleanup'), (_) => n.toggleAi('ai_writing_help', 'event_cleanup')),
          ...
          _T(Icons.event_outlined, 'Event Recommendations', n.aiVal('ai_suggestions', 'event_recommendations'), (_) => n.toggleAi('ai_suggestions', 'event_recommendations')),
